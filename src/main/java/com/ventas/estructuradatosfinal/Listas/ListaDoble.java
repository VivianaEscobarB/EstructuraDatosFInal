...
public class ListaDoble<T> implements Iterable<T> {
	...
	/**
	 * obtene el valor de un nodo dado un indice
	 * @param indice
	 * @return
	 */
	...
	/**
	 * verifica qe el indice si sea valido y exista en la lista
	 * @param indice
	 * @return
	 */
	...
	/**
	 * verifica si la lista tiene algo adentro, true o false
	 * @return
	 */
...
//
//		return new ListaDobleIterador2 (nodoPrimero);
//	}
//	
//	protected class ListaDobleIterador2 implements Iterator<E> {
//	    // instance variable
//	    private Node next1=head;
//	 
...
//	    	    E tmp = next1.item;
//	    	    next1 = next1.next;  // if next is null, hasNext will return false.
//	    	    return tmp;
//	    	}
//
//	    }
...
//	  // end class ListIterator
	...
	public void setTamanio(int tama) {
		this.tamanio = tama;
	}
